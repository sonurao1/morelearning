...
const ACCENT_STYLES = {
  "primary-action": {
    ...
    shadow:
      "group-hover:shadow-[0_25px_60px_-15px_rgba(16,84,232,0.35)]",
    background: "bg-primary-action/[0.05]",
  },
  ...
  digital: {
    ...
    shadow:
      "group-hover:shadow-[0_25px_60px_-15px_rgba(120,20,184,0.35)]",
    background: "bg-digital/[0.05]",
  },
  ...
  technology: {
    ...
    shadow:
      "group-hover:shadow-[0_25px_60px_-15px_rgba(3,140,163,0.35)]",
    background: "bg-technology/[0.05]",
  },
} as const;
  ...
  return (
    <article className="group relative w-[320px] shrink-0">
      ...
      >
        ...
        {/* Top accent line */}
        <div
          className={`absolute inset-x-0 top-0 h-1 ${styles.spine}`}
        />
        ...
        <Quote
          size={140}
          strokeWidth={0}
          className={`pointer-events-none absolute -right-6 -top-3 fill-current ${styles.glyph} transition-transform duration-500 group-hover:scale-110`}
        />
