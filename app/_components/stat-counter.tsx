...
export default function StatsCounter() {
  return (
    <section className=" mb-20 py-16 px-5 flex flex-col gap-14 items-center justify-center bg-secondary lg:px-8 lg:pb-0 xl:gap-20">



      {/* Stats counter */}
      <div className="container z-1 text-center grid grid-rows-4 grid-cols-1 gap-3.5 min-[512px]:grid-rows-2 min-[512px]:grid-cols-2 lg:grid-rows-1 lg:grid-cols-4 lg:bg-primary lg:rounded-2xl lg:-mb-20 xl:max-w-7xl">
